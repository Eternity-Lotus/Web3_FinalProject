"use strict";
//Animations, filling in the spots on the board
...
var Utils = (function() {
    ...
    Utils.drawCircle = function(context, _a) { //fills in an open spot on the board
        var _b = _a.x,
            x = _b === void 0 ? 0 : _b,
            _c = _a.y,
            y = _c === void 0 ? 0 : _c,
    ...
    Utils.clearCanvas = function(board) { //clears the board
    ...
    Utils.animationFrame = function() { //animation of a piece falling
        var resolve = null;
